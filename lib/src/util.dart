...
bool isConsistsOfEmojis(EmojiEnlargementBehavior emojiEnlargementBehavior,
...
List<Object> calculateChatMessages(List<types.Message> messages,
    types.User user, {
  ...
  for (var i = messages.length - 1; i >= 0; i--) {
    ...
    if (messageHasCreatedAt && nextMessageHasCreatedAt) {
      ...
      nextMessageDifferentDay = DateTime
